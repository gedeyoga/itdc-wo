<template>
    ...
    <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
        ...
        <a href="index.html" class="app-brand-link">
            ...
            <span class="app-brand-text demo menu-text fw-bolder ms-2">Samartha</span>
        </a>
        ...
        <ul class="menu-inner py-1">
            <template v-for="(group, g) in sideBarLinks.routes" >
              <li :key="group.group_name + g" class="menu-header small text-uppercase">
                  <span class="menu-header-text">{{ group.group_name }}</span>
              </li>
...
import routes from '../../../json/menu.json';
...
export default {
  ...
  methods: {
    toggleMenu(index , keySubmenu = null) {
        this.sideBarLinks
          .routes
          .forEach((group) => {
